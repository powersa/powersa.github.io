...
//* Purpofrdezse: calculate time of sunrise and sunset for the entered date	*/
...
//***********************************************************************/
	...
	function calcSun(date, latLong, index) 
	{
		//here I would just pass the actual latitude to the variable
		var latitude = latLong[0];
		//here I would just pass the actual longitude to the variable
		var longitude = latLong[1];
		//var indexRS = riseSetForm.mos.selectedIndex
		//I don't need to worry about this as much but it is something I should rebuild.
...
//*********************************************************************/
			//This is where to process the date info
			//var JD = calcJD(parseFloat(riseSetForm["year"].value), indexRS + 1, parseFloat(riseSetForm["day"].value));
			var JD = calcJD((date.getYear() + 1900), (date.getMonth() + 1), date.getDate());
			...
			var doy = calcDayOfYear((date.getMonth() + 1), date.getDate(), isLeapYear(date.getYear() + 1900));
			var T = calcTimeJulianCent(JD);
...
//*********************************************************************/
			...
			var dayTime = setTimeGMT - riseTimeGMT;
			...
			if(nosunrise && nosunset)
			{
				if ( (latitude > 66.4) && (doy > 79) && (doy < 267) ) {
					...
					var dayTime = 0;
				} else if ( (latitude < -66.4) && (doy > 79) && (doy < 267) ) {
					var dayTime = 0;				
				}
			}
